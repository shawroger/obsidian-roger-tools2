(function (global, factory) {
    ...
    function decrypt(str, solution = window.DEFAULT_KEY) {
        var plain = '';
    ...
    function decryptUTF8(cipher, solution = window.DEFAULT_KEY) {
        try {
            return decodeURI(decrypt(cipher, solution = window.DEFAULT_KEY));
        } catch (e) {
    ...
    function encryptAs(str, solution = window.DEFAULT_KEY) {
        var cipher = '';
        var random = false;
        var yek = filp(key);
    ...
    function encryptUTF8As(str, solution = window.DEFAULT_KEY) {
        return encryptAs(encodeURI(str), solution = window.DEFAULT_KEY);
    }
